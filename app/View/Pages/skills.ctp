...
<ul class="stars">
    ...
    <p><span class="b">Внимание!</span> На других сайтах мое резюме (CV) может быть не актуальным, т.к. я не всегда успеваю везде обновить свой профиль. </p>
    <p>Самая актуальная информация - на моем оффициальном сайте!</p>
