<h3># Кратко</h3>
<p class="sub">В нескольких словах обо мне</p>
<ul class="stars">
    <li>ответственный и коммуникативный</li>
    <li>опыт web-разработки более чем 10 лет</li>
    <li>знаю несколько PHP, JS и CSS фреймворков</li>
    <li>есть опыт управления проектами (team leader)</li>
    <li>свободно говорю по английски (fluent English)</li>
</ul>
<p>Разрабатывал как back-end, так и front-end. В основном работал на крупных и высоко-нагруженных серьезных проектах. Большой опыт сотрудничества с минскими компаниями, а также с Россией, Европой, Америкой.</p>
<p>Есть рекомендации моих как белорусских, так и европейских работодателей.</p>

<h3># О работе</h3>
<p class="sub">Что нужно знать при работе со мной</p>
...
<h3># Личное</h3>
<p class="sub">Личная информация обо мне</p>
...
<h3># Любимый веб</h3>
<p class="sub">Почему я люблю свою работу</p>
<ul class="stars">
...
<h3># Я - живой!</h3>
<p class="sub">У меня тоже есть свои увлечения</p>
...
<h3># Удаленка vs Фриланс</h3>
<p class="sub">Почему удаленная работа это не фриланс</p>
<p>Очень многие потенциальные работодатели или HR-специалисты, услышав про удаленную работу, сразу говорят что им фриланс не подходит. Однако удаленная работа - это НЕ фриланс:</p>
<?
    $aDiffs = array(
        array(
...
<h3># Удаленка vs Офис</h3>
<p class="sub">7 мифов про работу в офисе и почему не стоит боятся работать удаленно</p>
...
<?
    $aMyths = array(
        ...
        'Разработчик работает более эффективно в офисе, нежели удаленно' => array(
            ...
            В-третьих, если я на удаленке буду работать неэффективно, меня тут же уволят, и не важно чем я при этом занимался! Поэтому я нацелен на то, чтобы показать результат своей работы. А разработчик в офисе всегда может сказать, что он ведь был на работе. <br/>
